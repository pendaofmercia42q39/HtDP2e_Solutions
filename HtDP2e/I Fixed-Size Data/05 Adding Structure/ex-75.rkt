...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-75) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

; A UFO is a structure:
;   (make-ufo Posn Vel)
; interp: (make-ufo p v) is at location
